...
contract CDPManager {
    ...
    function setParametersContractAddress(address _parametersContractAdress)
        public
        onlyOwner
    {
        ...
        HasAccess(cdpList[_cdpIndex].owner)
    {
        ...
        uint256 newTotalDebt = (user_cdp.generatedDebt + _amount) *
            liquidationRatio;
    ...
    function liquidatePosition(uint _cdpIndex)
        public
        payable
        CDPExists(_cdpIndex)
