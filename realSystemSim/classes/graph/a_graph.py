...
class Graph:
    ...
    def add_to_graph(self, price_station, pool):
        self.m_prices.append(price_station.getMp())
        self.market_twap_prices.append(price_station.getMarketTwap())
        self.r_prices.append(price_station.getRp())
        self.eth.append(pool.getEth())
        self.noi.append(pool.getNoi())
        self.pool_ratio.append(pool.getEth() / (pool.getEth() + pool.getNoi()))
        self.relative_gap_mp_rp.append((price_station.getMp() - price_station.getRp()) / price_station.getRp())
        self.redemption_rate.append(price_station.getRr())
